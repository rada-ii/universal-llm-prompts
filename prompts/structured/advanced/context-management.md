[COMPAT HEADER — LONG CONTEXT]
• If the full document does not fit in context, process only the provided chunk.
• Return partial results plus: {"warning":"partial_context","recommendation":"send next chunk"}.
[/COMPAT]
...
| Strategy     | Document Length | Accuracy | Processing Time | Memory Efficiency |
| ------------ | --------------- | -------- | --------------- | ----------------- |
| Chunked      | 2000 words      | TBD      | TBD             | TBD               |
| Front-loaded | 2000 words      | TBD      | TBD             | TBD               |
| Iterative    | 2000 words      | TBD      | TBD             | TBD               |
